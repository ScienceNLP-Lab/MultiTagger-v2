...
import argparse
from common import LABELS, DATASET_REGISTRY, load_hf_dataset, count_lines, clean_for_json
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", required=True,
                        help="Path to LLM-SSC checkpoint (e.g. best_model.mdl).")
